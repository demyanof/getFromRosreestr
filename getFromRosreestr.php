...
function getReestr($nomer){
  ...
  $data = array(
    ...
    "start"=>0,
    "size"=>200,
    // Далее пример массива запроса,
    // перед заполнениемэтого массива
    // желательно попробовать свой адрес на сайте Россреестра
    // и заполнить данный массив по примеру пробного запроса на сайте Росреестра
    "address" => array(
        "regionCode"=>"21",
        "district"=>null,
        "city"=>"CITY",
